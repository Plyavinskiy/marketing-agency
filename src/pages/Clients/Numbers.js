...
function Numbers() {
  return (
    <div className="px-[152px] mt-20">
      <h2 className="text-2xl text-gray-600 my-5">Until today we have provided our services to...</h2>
      <div className="bg-secondary flex justify-between space-x-10 p-5 rounded">
