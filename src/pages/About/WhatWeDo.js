...
function WhatWeDo() {
  return (
    <div className="z-20">
      <h2 className="text-secondary text-7xl text-center z-20 font-semibold">
        What We Do?
      </h2>
      <div className="h-72 w-full bg-primary mt-12"></div>
      <div className="grid grid-cols-4 gap-10 mx-32 -mt-40">
        {services.map((service) => (
          <div
            key={service.title}
            className="p-5 bg-white border shadow-lg flex flex-col items-center space-y-5 transform hover:scale-105 duration-500"
          >
